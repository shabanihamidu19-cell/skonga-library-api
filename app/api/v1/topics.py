"""
SKONGA Library API — Topics Endpoint (hardened)
================================================
Add defensive error handling and logging around the topic detail endpoint.
"""
...
def get_topic(
    ...
    try:
        ...
        log_error(endpoint="/topics/{topic_id}", error=str(exc))
